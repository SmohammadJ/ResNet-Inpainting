...
def train_net(net,
    ...
    for epoch in range(epochs):
        ...
        plt.imsave(join(data_dir, 'samples', train_gt), label[15])

        train_in = f'{epoch+1}_train_in.png'
        plt.imsave(join(data_dir, 'samples', train_in), img[15,:,:,:3])
        ...
        plt.imsave(join(data_dir, 'samples', test_gt), label[15])

        test_in = f'{epoch+1}_test_in.png'
        plt.imsave(join(data_dir, 'samples', test_in), img[15,:,:,:3])
