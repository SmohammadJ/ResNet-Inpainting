...
class DataLoader():
    ...
    def applyDataAugmentation(self, img, bach_s, cw, data_augmentation):
    ...
    def __iter__(self):
        ...
        for i  in range (self.batch_num):
            ...
            img_list = self.applyDataAugmentation(data_image, self.batch_size, crop_width, data_augmentation)
